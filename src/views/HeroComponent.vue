<template>
	...
	<div
		class="md:h-screen h-[500px] bg-no-repeat bg-center bg-cover transition-all duration-300 pt-[120px]"
		:style="{ backgroundImage: `linear-gradient(rgba(0,0,0, .5), rgba(0,0,0, .5)), url(${getImageUrl('hero_1.webp')})` }"
	>
